...
export const quizData = [
  {
    question: 'Quais são os gases abaixo que não participam do efeito estufa?',
    answer: 'Gás Ozônio',
    answers: ['Gás Carbônico', 'Gás Ozônio', 'Gás Metano', 'Gás Estufa']
  },
  {
    question: 'Quais são os animais abaixo que comem?',
    answer: 'Todos',
    answers: ['Nenhum', 'Apenas um', 'Apenas dois', 'Todos']
  },
]